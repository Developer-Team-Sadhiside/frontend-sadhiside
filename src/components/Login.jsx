              ...
              <div className="col-md-7">
                ...
                <form>
                  ...
                  <div className="form-group first">
                    <label>email</label>
                    <input type="text" className="form-control" placeholder="Masukan Email" value={email} onChange={onChangeEmail} />
                  </div>
                  <div className="form-group last mt-5">
                    <label>Password</label>
                    <input type={password} className="form-control" placeholder="Enter your password" name="password" value={password2} onChange={onChangePassword} />
